...
public class Vault2 extends AppCompatActivity implements View.OnClickListener {
...
*/
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        AlertDialog.Builder nameFile = new AlertDialog.Builder(Vault2.this);

        final EditText nameOfFile = new EditText(Vault2.this);
